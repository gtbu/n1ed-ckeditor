...
<p>You can register for a free Api-key at N1ED.com , which you can paste into the config.js include/thirdparty/ckeditor -> config.js (add to the end : config.apiKey = "AFFxktthzt...jatjri7uggG7"; </p>    
